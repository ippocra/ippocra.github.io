...
Παρέχεται μόνο για διευκόλυνση και, σε περίπτωση αμφιβολίας, υπερισχύει πάντα η ιταλική έκδοση στο <a {% static_href %}href="/legal/terms/"{% endstatic_href %}>/legal/terms/</a>.
{: .notice--warning}
