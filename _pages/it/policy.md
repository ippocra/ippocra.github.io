...
1. **Definizioni**
   ...
   5. **Identità del Titolare del Trattamento**
   ...
   9. **I diritti che puoi esercitare sui tuoi dati personali**
   ...
   13. **DPO e relativi recapiti**

   14. **4.14. Link ad altri siti web**

**5\. INFORMAZIONI SPECIFICHE PER GLI UTENTI FINALI**

1. **Finalità del trattamento, basi giuridiche e periodi di conservazione**

   2. **Creare un account anche relativo o per conto di terze persone**

   3. **Inclusione di dati di terzi nell'account dell'Utente Finale**

   4. **Ruolo della Società come Responsabile del trattamento dei dati di Professionisti o Strutture Sanitarie**
...
1. **Cosa sono i Cookies**
   ...
   2. **Altre tecnologie simili ai Cookies utilizzate**

   3. **Tipologia di cookies utilizzati**

   4. **Come prestare il consenso ai cookies, revocarlo o modificare le preferenze**

   5. **Gestione dei cookies attraverso il browser**

   6. **Conservazione dei cookies**
...
L'utente è invitato a leggere con attenzione la presente informativa e la sezione “**Termini e Condizioni**”([LINK](http://ippocra.com/legal/terms/)) prima di utilizzare uno qualsiasi dei nostri servizi e di aprire un account sul nostro sito ippocra.com (“**Account**”).
...
Tutti i dati vengono raccolti al momento della creazione dell'Account e/o attraverso moduli che gli Utenti compilano nell'ambito dell'utilizzo dei Servizi e, in generale, nel contesto dell'utilizzo dei Servizi offerti dalla Società, in particolare tutti i dati sanitari e biometrici contenuti nelle immagini e/o scansioni dei referti, cartelle cliniche, esami, che decidi di caricare verranno automaticamente raccolti e archiviati. Il Sito raccoglie dati automaticamente quando i Visitatori navigano il sito; per l'analisi del traffico utilizziamo Umami, un servizio di analytics self-hosted che non utilizza cookie né traccia i singoli utenti (vedi punto 8).
...
Per inviarci domande e richieste potrai utilizzare l'indirizzo mail: [info@ippocra.com](mailto:info@ippocra.com)  oppure utilizzare il modulo di contatto presente sul Sito, oppure scriverci all'indirizzo: IPPOCRA S.R.L. Via Podgora 47, CAP 60124, Ancona.
...
| Trattare dati aggregati, metriche, analytics relativi alla tua attività sul sito o sull'app, per eseguire analisi interne, ottenere metriche e dati per migliorare i nostri servizi o rilevare malfunzionamenti; per gestire attività commerciali. L'analisi del traffico sito web è gestita tramite Umami, un servizio di analytics self-hosted. | Informazioni sul tuo dispositivo, tipo di browser, lingua, sistema operativo, data e ora della visita, pagine visitate sul sito. I dati sono anonimi e non vengono utilizzati cookie di tracciamento. | Trattiamo questi dati in base al nostro legittimo interesse a condurre analisi interne per misurare le metriche della nostra attività allo scopo di fornirti un servizio sempre migliore. | Conserveremo i tuoi dati per un periodo non superiore a 3 anni a partire dal momento in cui il trattamento si è verificato, per adempiere agli obblighi legali. |
...
I tuoi dati verranno conservati per un periodo non superiore a 1 anno a partire dal momento in cui il trattamento si è verificato.
