...
From the very beginning when we [launched IppoLink]({% post_url en/2024-12-06-ippolink-launch %}){:target="_blank"}, Ippocra has allowed users to save documents received via Ippolink into their 
own personal plan, selecting the appropriate user profile. This capability remains available with our 
free _Ippo_ plan for everyone, as we outlined [when we opened for business]({% post_url en/2025-03-07-open-for-business %}){:target="_blank"}.

Starting today, Ippocra introduces a new opportunity: the **Sponsored Plan**, which can be activated 
by our business users for their clients. [Healthcare practices like Medical Campus]({% post_url en/2025-05-14-medical-campus-sceglie-ippocra %}){:target="_blank"} are already seeing the benefits of this approach.
