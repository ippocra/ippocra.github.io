...
<a href="https://app.ippocra.com/it/register" class="btn btn--primary btn--x-large">Start Managing Your Medical Reports with Ippocra → Free Registration • Guaranteed Privacy • Full Control<i class="fa-solid fa-arrow-right"></i></a>
{: .text-center}
