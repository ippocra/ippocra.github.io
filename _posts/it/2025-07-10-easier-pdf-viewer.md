...
e vogliamo sempre migliorare il nostro prodotto per venire incontro alle loro esigenze. Quando [abbiamo aggiunto il supporto per gli archivi ZIP]({% post_url it/2025-03-27-archive-support %}){:target="_blank"}, gli utenti hanno anche richiesto un modo migliore per visualizzare i documenti da dispositivi mobili.
...
Perché la **Ricerca Intelligente** che [abbiamo introdotto nella beta]({% post_url it/2024-10-03-opening-private-beta %}){:target="_blank"}—e che puoi usare con [il piano gratuito Ippo]({% post_url it/2025-05-07-take-the-ippo-for-a-ride %}){:target="_blank"}—trova quello che ti serve, 
quando ti serve.
